 ...
 setTotalPrice(sum)
  ...
  <div className="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32">
    <div className="px-4 pt-8">
      ...
      <div className="mt-8 space-y-3 rounded-lg border bg-white px-2 py-4 sm:px-6 h-96 overflow-y-auto">
...
return(
  ...
  <Card key={item.image+item.Name+item.price+item._id+item._description}
  
  className="flex flex-row rounded-lg bg-white sm:flex-row hover:scale-105">
          <img
